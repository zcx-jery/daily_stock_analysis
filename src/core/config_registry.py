...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MOMENTUM_SECTOR_CACHE_TTL_SECONDS": {
        "title": "Momentum Sector Cache TTL (Seconds)",
        "description": "TTL for Shenwan Level-1 sector mapping cache used by momentum screener.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOMENTUM_SCREENER_DEFAULT_PROFILE": {
        "title": "Momentum Screener Default Profile",
        "description": "Default profile used by the momentum screener page when no local state has been saved.",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["standard", "aggressive"]},
        "display_order": 59,
    },
    "MOMENTUM_SCREENER_DEFAULT_TOP_N": {
        "title": "Momentum Screener Default Top N",
        "description": "Legacy display default; V1 official momentum screener output is fixed to Top30.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOMENTUM_SCREENER_DEFAULT_MIN_CHANGE_PCT": {
        "title": "Momentum Screener Default Min Change (%)",
        "description": "Legacy display default; V1 official candidate baseline is fixed at 4%.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOMENTUM_SCREENER_DEFAULT_MIN_AMOUNT_YI": {
        "title": "Momentum Screener Default Min Amount (Yi)",
        "description": "Legacy display default; V1 official candidate amount baseline is fixed at 2 Yi Yuan.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOMENTUM_SCREENER_DEFAULT_MIN_TURNOVER": {
        "title": "Momentum Screener Default Min Turnover (%)",
        "description": "Legacy display default; V1 official candidate turnover baseline is fixed at 2%.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
