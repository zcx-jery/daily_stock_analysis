...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MOMENTUM_SCREENER_DEFAULT_TOP_N": {
        ...
        "description": "Default top-N result count used by the momentum screener page.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOMENTUM_SCREENER_DEFAULT_MIN_CHANGE_PCT": {
        ...
        "description": "Default minimum daily percentage gain used by the momentum screener page.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOMENTUM_SCREENER_DEFAULT_MIN_AMOUNT_YI": {
        ...
        "description": "Default minimum成交额 threshold in Yi Yuan used by the momentum screener page.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MOMENTUM_SCREENER_DEFAULT_MIN_TURNOVER": {
        ...
        "description": "Default minimum turnover percentage used by the momentum screener page.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
