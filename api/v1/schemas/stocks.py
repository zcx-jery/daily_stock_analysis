...
class MomentumDecisionPortfolioSlot(BaseModel):
    ...
    v13_theme_strength_score: Optional[float] = Field(None, description="V1.3 影子分-真实题材强度")
    v13_fund_support_score: Optional[float] = Field(None, description="V1.3 影子分-资金承接")
    v13_limit_structure_score: Optional[float] = Field(None, description="V1.3 影子分-涨停结构")
    v13_buyability_score: Optional[float] = Field(None, description="V1.3 影子分-买入可行性")
    v13_chip_risk_score: Optional[float] = Field(None, description="V1.3 影子分-筹码风险")
    v13_shadow_score: Optional[float] = Field(None, description="V1.3 影子总分，仅用于诊断观察")
    v13_shadow_summary: Optional[str] = Field(None, description="V1.3 影子分诊断摘要")
