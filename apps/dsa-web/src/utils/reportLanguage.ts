...
const REPORT_TEXT = {
  zh: {
    ...
    mappedAliases: '字段映射',
    rawKeyLevels: '原始点位字段',
    unmappedKeyLevels: '未映射字段',
    dashboardExtra: '补充文本字段',
    noDriftFields: '暂无扩展字段',
    noValue: '—',
    newsFeed: '资讯动态',
    relatedNews: '相关资讯',
    refresh: '刷新',
  ...
  en: {
    ...
    driftFields: 'Extra Fields',
    mappedAliases: 'Field Mapping',
    rawKeyLevels: 'Raw Level Fields',
    unmappedKeyLevels: 'Unmapped Fields',
    dashboardExtra: 'Supplemental Text Fields',
    noDriftFields: 'No extra fields',
    noValue: '—',
    newsFeed: 'NEWS FEED',
