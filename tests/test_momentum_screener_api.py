...
def _build_fake_screening_result(profile="standard", candidate_count=1):
    result = {
        ...
        "official_score": 91.0 if profile == "aggressive" else 84.0,
        ...
        "portfolio": [
            {
                ...
                "score": 89.2,
                "official_score": result["official_score"],
                "base_rank_score": result["official_score"],
                "risk_score": result["risk_score"],
                "decision_adjustment": 1.4,
                "decision_adjustment_reason": "Theme clarity and slot fit support keeping this name in the main slot.",
                "hard_blockers": [],
                "soft_adjustments": [
                    {"key": "theme_tailwind", "label": "Theme Tailwind", "delta": 0.8},
                    {"key": "planned_buy_point", "label": "Planned Buy Point", "delta": 0.6},
                ],
                "buy_point_status": "clear",
                "buy_point_label": "Clear",
